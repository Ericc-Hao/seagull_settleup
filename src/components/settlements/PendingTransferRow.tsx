  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={[typography.caption, { color: colors.owe, fontWeight: '600', marginTop: 2 }]} numberOfLines={1}>
          {statusLine}
        </Text>
      </View>
      <Text style={[typography.bodyMedium, { color: colors.textPrimary, marginRight: 8 }]}>{transfer.amountDisplay}</Text>
